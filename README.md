...
# Realtime branch
For realtime tracking on a [<b>NVidia Jetson Nano</b>](https://developer.nvidia.com/embedded/jetson-nano-developer-kit). See [here](https://devtalk.nvidia.com/default/topic/1067257/jetson-projects/realtime-pupil-detection-with-jetson-nano-and-deeplabcut/) for more details on how to set this up.
